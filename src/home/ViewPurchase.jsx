...
//         `http://localhost:5000/purchase/viewPurchaseRecord/${companyName}`,
//         {
...
//                 <td>{new Date(list.purchase_date).toLocaleDateString("en-CA")}</td>
...
//                 <td>{list.purchase_commission}</td>
  ...
  return (
    <div className="container mt-4">
      {/* <div className="text-center text-light bg-dark p-3 rounded">
        ...
        <div>
          <button onClick={() => getPurchaseHistory()}>Submit</button>
        </div>
      </div> */}
...
<div className="text-center text-light bg-dark p-4 rounded shadow-lg w-50 mx-auto my-5">
  ...
  <button className="btn btn-primary" onClick={() => getPurchaseHistory()}>
    Submit
  </button>
</div>
